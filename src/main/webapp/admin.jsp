            ...
            <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                <div class="service-box">
                    <div class="service-content">
                        ...
                        <h4><a href="#">Add New Item</a></h4><br>
                        <p>Add new items and display for customers.</p><br>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                <div class="service-box">
                    <div class="service-content">
                        ...
                        <h4><a href="#">Remove Item</a></h4><br>
                        <p>Remove finished items and expire items.</p><br>
                        <a href="adminRemove.jsp" class="itg-button active">Start</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                <div class="service-box">
                    <div class="service-content">
                        ...
                        <h4><a href="#">Update Item</a></h4><br>
                        <p>Update existing items and display for the customers</p><br>
                        <a href="adminUpdate.jsp" class="itg-button active">Start</a>
                    </div>
                </div>
            </div>
